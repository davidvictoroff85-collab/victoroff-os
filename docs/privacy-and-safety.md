# Public concept privacy and safety

The public site is a guide, not an intake system.

It must not receive, process, or retain:

- names, addresses, dates of birth, shareholder identifiers, or contact details;
- passwords, PINs, Social Security numbers, banking details, or authentication factors;
- document uploads, applications, proxies, ballots, forms, or submissions;
- analytics identifiers, cookies, local storage, session storage, or advertising data.
